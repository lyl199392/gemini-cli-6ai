...
The Gemini CLI Companion extension seamlessly integrates [Gemini CLI](https://github.com/aigo666/gemini-cli-new) into your VS Code environment. This integration enables Gemini CLI to access active information like your open files.
...
By installing this extension, you agree to the [Terms of Service](https://github.com/aigo666/gemini-cli-new/blob/main/docs/tos-privacy.md).
